...
CREATE TABLE `bookings` (
  ...
  KEY `fk_Bookings_Delivery1_idx` (`Delivery_DeliveryID`),
  CONSTRAINT `fk_Bookings_Delivery1` FOREIGN KEY (`Delivery_DeliveryID`) REFERENCES `delivery` (`DeliveryID`)
...
CREATE TABLE `customer` (
  ...
  KEY `fk_Customer_Staff1_idx` (`Staff_StaffID`),
  CONSTRAINT `fk_Customer_Staff1` FOREIGN KEY (`Staff_StaffID`) REFERENCES `staff` (`StaffID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menu` (
  ...
  KEY `fk_Menu_Customer1_idx` (`Customer_CustomerID`),
  CONSTRAINT `fk_Menu_Customer1` FOREIGN KEY (`Customer_CustomerID`) REFERENCES `customer` (`CustomerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-30 12:37:59
